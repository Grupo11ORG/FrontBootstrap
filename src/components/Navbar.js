    ...
    return (
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 navbar-shrink" id="mainNav">
            <div class="container px-4 px-lg-5">
                <Link className="navbar-brand" to='/'><i class="glyphicon glyphicon-phone"></i>TechSearch</Link>
                    ...
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        {session === null ? (
                            <>
                                ...
                                <li class="nav-item"><Link className="nav-link" to='/perfil'>PerfilTec</Link></li>
                                <li class="nav-item"><Link className="nav-link" to='/admin'>Admin</Link></li>
